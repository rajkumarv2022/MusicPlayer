...
export default function SongSinglePage() {
    ...
    type Songdet = {
     ...
     useEffect(() => {
      fetch(`http://localhost:3001/song/${song_id}`)
      ...
      <div className='flex flex-col gap-8'>
        ...
        <div className='flex flex-row gap-4 items-center justify-between px-4 mt-4'>
            ...
            <div className='flex flex-col'>
                ...
                <p className='text-white'>{songdetail?.albumname}</p>
            </div>
        ...
        <div className='flex flex-col items-center justify-center'>
            <img className='w-80 h-84' src={songdetail?.imageurl} alt="" />
        </div>
        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-row items-center justify-center gap-20'>
                ...
                <div className='flex flex-col'>
                    <p className='text-white'>{songdetail?.songname}</p>
